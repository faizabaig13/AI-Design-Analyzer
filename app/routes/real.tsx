      ...
      <main className="bg-[url('/images/bg-main.svg')] bg-cover min-h-screen">
        ...
        <section className="main-section">
          <div className="page-heading py-16 text-center">
            <h1>Loading Design Analysis...</h1>
            <img src="/images/resume-scan-2.gif" className="w-[200px] mx-auto mt-4" alt="Loading" />
            <p className="text-gray-600 mt-4">Please wait while we load your design analysis</p>
          </div>
        </section>
      </main>
    );
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {Object.entries(design.feedback.analysis).map(([key, value]) => (
                  ...
                  >
                    <h4 className="font-semibold text-lg text-gray-800 mb-2 capitalize">
                      {key === "userExperience"
                        ? "User Experience"
                        : key === "accessibility"
                        ? "Accessibility"
                    ...
                    <p className="text-gray-700 flex-grow">{value}</p>
                  </div>
                ))}
              </div>
            </div>
